...
const formatType = (type: DocgenType) => {
...
export const DocsViewer = ({ component }: DocsViewerProps) => {
    ...
    <ViewerWrapper>
      ...
      <NocturnaCard variant="void" style={{ padding: 0, overflow: "visible" }}>
        <HeaderSection>
          ...
          <ComponentDescription>{docs.description}</ComponentDescription>
        </HeaderSection>
        ...
        {hasProps ? (
          <div style={{ width: "100%", position: "relative" }}>
            ...
            <div style={{ display: "flex", flexDirection: "column" }}>
              {Object.values(docs.props).map((prop) => (
                <PropRow key={prop.name}>
                  ...
                  <DataCol $span={2}>
                    ...
                    <div>
                      {prop.defaultValue ? (
                        <DefaultValue>{prop.defaultValue.value}</DefaultValue>
                      ) : (
                        <span
                          style={{
                            fontFamily: "monospace",
